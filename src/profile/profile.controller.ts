...
import { ProfileRO, ProfileDataWithId} from './profile.interface';
...
export class ProfileController {
 ...
 /***************get by id************/
  @Get(':id')
  async getProfileById(@User() userId: number, @Param('id') id): Promise<ProfileDataWithId> {
    return await this.profileService.findUserById( id);
  }
